...
class _QuizScreenState extends State<QuizScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: const Color.fromARGB(255, 184, 191, 243),
      body: Container(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: const Color.fromARGB(255, 30, 180, 255),
    ...
    return Container(
      ...
      child: ElevatedButton(
        style: ElevatedButton.styleFrom(
          ...
          backgroundColor: isSelected ? const Color.fromARGB(255, 16, 174, 232) : Colors.white,
